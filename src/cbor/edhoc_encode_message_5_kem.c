...
static bool encode_message_5_kem(zcbor_state_t *state, const struct zcbor_string *input);


static bool encode_message_5_kem(
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)input, payload_len_out, states,
		(zcbor_decoder_t *)encode_message_5_kem, sizeof(states) / sizeof(zcbor_state_t), 1);
}
