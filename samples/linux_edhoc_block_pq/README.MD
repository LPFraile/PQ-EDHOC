...
Optionally can be chosen three diferent paramete to manage the retransmisions when the tarnsport layers is setting to TCP. This must be selected in the Initiator/src/main.c code.
