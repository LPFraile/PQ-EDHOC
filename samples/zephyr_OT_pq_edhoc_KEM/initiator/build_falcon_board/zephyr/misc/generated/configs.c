...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COAP_SAMPLE_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 28000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_THREAD_STACK_SIZE, 8192);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_NUM_MESSAGE_BUFFERS, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_MESSAGE_BUFFER_SIZE, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_COAP_BLOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TINYCRYPT_AES_CBC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TINYCRYPT_AES_CTR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TINYCRYPT_AES_CCM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 10192);
